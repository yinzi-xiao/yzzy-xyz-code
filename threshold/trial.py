...
error_probability_min, error_probability_max = 0.46, 0.5
...
if __name__ == '__main__':
    ...
    error_model = BiasedDepolarizingErrorModel(bias=300,axis='X')
    ...
    function.save_simdata(os.path.join(save_path,'xyz_x300bias{}.json'.format(task_id)),data)
