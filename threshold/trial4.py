...
error_probability_min, error_probability_max = 0.35, 0.39
...
if __name__ == '__main__':
    ...
    error_model = BiasedDepolarizingErrorModel(bias=100,axis='X')
    ...
    function.save_simdata(os.path.join(save_path,'xyz_x100bias{}.json'.format(task_id)),data)
